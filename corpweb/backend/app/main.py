...
# Import routers
from app.api.v1 import auth, configs, admin, monitoring, antizapret, public, agent, nodes, apply_status, balancer, admin_dashboard
...
app.add_middleware(
    ...
    allow_methods=["*"],
    allow_headers=["*"],
    expose_headers=["X-QR-Type", "Content-Disposition"],
)
